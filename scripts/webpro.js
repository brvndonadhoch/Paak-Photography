    ...
    d.widget("Widget.Form", d.Widget, {
      ...
      _submitFormInternal: function() {
        ...
        b.ajax({
          ...
          complete: function(j) {
            j && (j.status >= 400 || j.responseText && j.responseText.indexOf("<?php") >= 0) && alert("We are having trouble contacting our server. Kindly contact us via phone or directly on paakphotography@gmail.com");
    ...
    if (-1 != c) {
      ...
      for (var c = document.getElementsByTagName("meta"), b = 0, d = c.length; b < d; b++) {
        ...
        if ("generator" == a.getAttribute("name")) {
          "2018.1.1.386" != a.getAttribute("content") && Muse.assets.outOfDate.push("webpro.js");
          break
        }
      }
    }
